...
while True:
  ...
  try:
    ...
    # ~~~~ INSERT CODE ~~~~
    clientSocket, args.hostname = serverSocket.accept()
    # ~~~~ END CODE INSERT ~~~~
  ...
  try:
    ...
    cacheContent += line
    clientSocket.sendall(cacheContent)
    # ~~~~ END CODE INSERT ~~~~
  ...
  # Error handling for file not found in cache
    ...
    if fileExists:
      ...
      try:
        ...
        # ~~~~ INSERT CODE ~~~~
        originServerRequest = 'GET' +" "+resource +" "+ version
        ...
        originResponse = ''
        while 1:
           transRes = originServerSocket.recv(BUFFER_SIZE)
           if not transRes:
              break
           originResponse += transRes
        # ~~~~ END CODE INSERT ~~~~

        # Send the response to the client
        # ~~~~ INSERT CODE ~~~~
        originServerSocket.sendall(originResponse)
